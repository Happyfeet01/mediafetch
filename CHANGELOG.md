...
- Completed HTTP, magnet and torrent downloads now appear in Nextcloud without requiring a manual `occ files:scan`. [Issue #4]

## [1.0.3] - 2026-07-23

### Changed
- Internationalization so that it works and the app is useful to more people. [Issue #11][Issue #13][Issue #14][Issue #15]

### Fixed
- Download progress for torrents was not showning. Even the completed torrent files were not showing in the completed section. [Issue #10]

[1.0.3]: https://github.com/wolfravenous/vapor/releases/tag/v1.0.3
[Issue #10]:https://github.com/wolfravenous/vapor/issues/10
[Issue #11]:https://github.com/wolfravenous/vapor/issues/11
